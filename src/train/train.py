...
from module.func import unfreeze_ffn_connections_with_hooks_optimized, compute_metrics
...
if __name__ == "__main__":
    ...
    match args:
        ...
        case args.train_target_neurons:
            hooks = unfreeze_ffn_connections_with_hooks_optimized(
                model, trainable_neurons
            )
            for param in model.classifier.parameters():
                param.requires_grad = True
        case args.full:
