...
difference_coordinates = set(counter_file2) - set(counter_file1)
...
total_difference_coordinates = len(difference_coordinates)
...
print(f"Difference coordinates: {total_difference_coordinates}")
